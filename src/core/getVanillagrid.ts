...
const handler = {
    ...
    getDatasWithClearFilterValue(gridId: string, datas: CellData[][]) {},
    ...
    setCellDataFromColInfo(cellDataOrCell: CellData | Cell, colInfo: ColInfo) {},
    getSortSpan(gridId: string, colId: string) {},
    ...
    _getFilterSpan() {},
    _getFooterFormula() {},
    _getColDefaultAlign(dataType: string) {},
